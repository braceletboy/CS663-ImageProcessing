...
%% Raster Scan loop
%
for raster_row = 1:int64(((1-overlap_factor)*patch_size)):final_size-int64((overlap_factor)*(patch_size))
    for raster_column = 1:int64(non_overlap*patch_size):final_size-int64(overlap_factor*(patch_size))
